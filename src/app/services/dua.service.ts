  ...
  private libraryDuas: Dua[] = [
    {
      ...
      transcription: 'Раббана атина фи-ддунья хасанатан ва филь-ахырати хасанатан ва кына ‘азабан-нар.',
    ...
    },
    {
      ...
      transcription: 'Йа Муқаллиба-ль-кулюби сяббит қальби \'аля диник(а). Аллаһумма мусаррифа-ль-кулюби сарриф қулюбана аля та\'атик (а).',
    ...
    },
    {
      ...
      transcription: 'Аллаһумма-гфир ли занби, ва васси ли фи дари, ва барик ли фима разақтани.',
      reference: 'Тирмизи'
    },
    {
      id: 's5',
      ...
      transcription: 'Аллаһумма-нфа\'ни бима аллямтани ва аллимни ма янфа\'унӣ ва зидни \'илма (н).',
      reference: 'Ибн Маджа'
    },
    {
      id: 's6',
